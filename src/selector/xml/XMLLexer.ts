// Generated from grammars/xml/XMLLexer.g4 by ANTLR 4.9.0-SNAPSHOT
...
export class XMLLexer extends Lexer {
    ...
    // tslint:disable:no-trailing-whitespace
    public static readonly modeNames: string[] = ['DEFAULT_MODE', 'INSIDE', 'PROC_INSTR'];
    ...
    public get ruleNames(): string[] {
        return XMLLexer.ruleNames;
    }

    // @Override
    public get serializedATN(): string {
        return XMLLexer._serializedATN;
    }

    // @Override
    public get channelNames(): string[] {
        return XMLLexer.channelNames;
    }

    // @Override
    public get modeNames(): string[] {
        return XMLLexer.modeNames;
    }
