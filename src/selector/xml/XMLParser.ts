// Generated from grammars/xml/XMLParser.g4 by ANTLR 4.9.0-SNAPSHOT
...
export class XMLParser extends Parser {
    ...
    public static readonly ruleNames: string[] = ['document', 'prolog', 'content', 'element', 'reference', 'attribute', 'chardata', 'misc'];
    ...
    public get ruleNames(): string[] {
        return XMLParser.ruleNames;
    }

    // @Override
    public get serializedATN(): string {
        return XMLParser._serializedATN;
    }
    ...
    public document(): DocumentContext {
        ...
        try {
            this.enterOuterAlt(_localctx, 1);
            {
                ...
                while (
                    (_la & ~0x1f) === 0 &&
                    ((1 << _la) & ((1 << XMLParser.COMMENT) | (1 << XMLParser.SEA_WS) | (1 << XMLParser.PI))) !== 0
                ) {
                    {
                        {
                            this.state = 19;
...
export class ElementContext extends ParserRuleContext {
    ...
    public SLASH(): TerminalNode | undefined {
        return this.tryGetToken(XMLParser.SLASH, 0);
    }
    public attribute(): AttributeContext[];
    public attribute(i: number): AttributeContext;
    public attribute(i?: number): AttributeContext | AttributeContext[] {
    ...
    public SLASH_CLOSE(): TerminalNode | undefined {
        return this.tryGetToken(XMLParser.SLASH_CLOSE, 0);
    }
    constructor(parent: ParserRuleContext | undefined, invokingState: number) {
        super(parent, invokingState);
    }
...
export class ReferenceContext extends ParserRuleContext {
    public EntityRef(): TerminalNode | undefined {
        return this.tryGetToken(XMLParser.EntityRef, 0);
    }
    public CharRef(): TerminalNode | undefined {
        return this.tryGetToken(XMLParser.CharRef, 0);
    }
    constructor(parent: ParserRuleContext | undefined, invokingState: number) {
        super(parent, invokingState);
    }
...
export class ChardataContext extends ParserRuleContext {
    public TEXT(): TerminalNode | undefined {
        return this.tryGetToken(XMLParser.TEXT, 0);
    }
    public SEA_WS(): TerminalNode | undefined {
        return this.tryGetToken(XMLParser.SEA_WS, 0);
    }
    constructor(parent: ParserRuleContext | undefined, invokingState: number) {
        super(parent, invokingState);
    }
...
export class MiscContext extends ParserRuleContext {
    public COMMENT(): TerminalNode | undefined {
        return this.tryGetToken(XMLParser.COMMENT, 0);
    }
    public PI(): TerminalNode | undefined {
        return this.tryGetToken(XMLParser.PI, 0);
    }
    public SEA_WS(): TerminalNode | undefined {
        return this.tryGetToken(XMLParser.SEA_WS, 0);
    }
